...
public class KreisUhr extends JFrame implements PropertyChangeListener {
	...
	private static final int[] ZEIGERLAENGE = new int[] { 5 * RADIUS / 10, 6 * RADIUS / 10, 7 * RADIUS / 10 }; // Längen
																												// der 3
																												// Zeiger
	private static final Color[] ZEIGERFARBE = new Color[] { Color.red, Color.green, Color.blue }; // Farben der 3
																									// Zeiger
	...
	public void paint(Graphics g) {
		...
		final int[] zeit = new int[] { uhr.getStunde(), uhr.getMinute(), uhr.getSekunde() };
